...
type NilExample struct {
	...
	Id      int64                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	StrNil  *wrappers.StringValue `protobuf:"bytes,2,opt,name=str_nil,json=strNil,proto3" json:"str_nil,omitempty"`
	TimeNil *timestamp.Timestamp  `protobuf:"bytes,3,opt,name=time_nil,json=timeNil,proto3" json:"time_nil,omitempty"`
}
...
func (x *NilExample) GetStrNil() *wrappers.StringValue {
	if x != nil {
		return x.StrNil
	}
	return nil
...
func (x *NilExample) GetTimeNil() *timestamp.Timestamp {
	if x != nil {
		return x.TimeNil
	}
	return nil
...
func (x *User) GetJoined() *timestamp.Timestamp {
	if x != nil {
		return x.Joined
	}
	return nil
...
func (x *User) GetOptNum() *wrappers.Int64Value {
	if x != nil {
		return x.OptNum
	}
	return nil
...
func (x *User) GetOptStr() *wrappers.StringValue {
	if x != nil {
		return x.OptStr
	}
	return nil
...
func (x *User) GetOptBool() *wrappers.BoolValue {
	if x != nil {
		return x.OptBool
	}
	return nil
...
func (x *User) GetBigInt() *wrappers.StringValue {
	if x != nil {
		return x.BigInt
	}
	return nil
...
func (x *User) GetBUser_1() *wrappers.Int64Value {
	if x != nil {
		return x.BUser_1
	}
	return nil
...
func (x *User) GetType() *wrappers.StringValue {
	if x != nil {
		return x.Type
	}
	return nil
